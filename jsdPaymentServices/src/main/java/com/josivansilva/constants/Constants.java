...
package com.josivansilva.constants;
...
public class Constants {
	 ...
	 */
	public static final String DEFAULT_SMTP_HOST = "smtpi.josivansilva.com";

	/**
	 * Constant that defines the default smtp authentication user.
	 */
	public static final String DEFAULT_SMTP_AUTH_USER = "noreply@josivansilva.com";
	 ...
	 */
	public static final String DEFAULT_SENDER = "noreply@josivansilva.com";
	 ...
	 */
	public static final String CONTACT_SUBJECT_FORGOT_PWD = "JSD Payment - Recuperação de senha";	
